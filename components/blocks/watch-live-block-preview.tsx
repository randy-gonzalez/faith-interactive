  ...
  return (
    <div {...advancedProps} className={combinedClassName} style={backgroundStyle}>
      ...
      <div className={`max-w-3xl mx-auto relative z-10 flex flex-col ${alignmentClass}`}>
          ...
          <div className="mb-6">
            {status.isLive ? (
              ...
              <div className="space-y-3">
                <p className={`text-sm font-medium ${subTextColorClass} uppercase tracking-wider`}>
                  {countdownPrefix}
                </p>
                <div className="flex gap-2 sm:gap-4 justify-center">
                  {timeRemaining.days > 0 && (
                    <CountdownUnit value={timeRemaining.days} label="Days" hasBackground={hasBackground} />
                  )}
                  <CountdownUnit value={timeRemaining.hours} label="Hours" hasBackground={hasBackground} />
                  <CountdownUnit value={timeRemaining.minutes} label="Min" hasBackground={hasBackground} />
                  <CountdownUnit value={timeRemaining.seconds} label="Sec" hasBackground={hasBackground} />
                </div>
                {status.label && (
              ...
              <p className={`text-sm ${subTextColorClass} italic`}>
        ...
        {/* Heading */}
        {data.heading && (
          <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold ${textColorClass} mb-3`}>
            {data.heading}
          </h2>
        )}
        ...
        {/* Subheading */}
        {data.subheading && (
          <p className={`text-lg md:text-xl ${subTextColorClass} mb-8 max-w-xl`}>
            {data.subheading}
          </p>
        )}
        ...
        {!data.livestreamUrl && (
          <p className={`mt-4 text-sm ${subTextColorClass} italic`}>
    ...
    >
      ...
      <span
        className={`
          ...
          ${hasBackground ? "text-white/70" : "text-gray-400"}
        `}
      >
        {label}
      </span>
