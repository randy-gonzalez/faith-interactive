      ...
      <section className="section">
        <div className="container">
          <div className="max-w-4xl">
            ...
            <ScrollReveal delay={0.1}>
              <h2 className="h2 mb-12">The people behind the pixels.</h2>
            </ScrollReveal>

            {/* Randy Gonzalez */}
            <ScrollReveal delay={0.15}>
              <div className="py-10 border-b border-[#e5e5e5] flex flex-col sm:flex-row gap-6 sm:gap-8">
                <div className="shrink-0">
                  <img
                    src="https://assets.faith-interactive.com/platform/media/randy-gonzalez-58ma.jpg"
                    alt="Randy Gonzalez"
                    className="w-24 h-24 sm:w-28 sm:h-28 object-cover grayscale"
                  />
                </div>
                <div>
            ...
            <ScrollReveal delay={0.35}>
              <div className="py-10 flex flex-col sm:flex-row gap-6 sm:gap-8">
                <div className="shrink-0">
                  <img
